...
@CommonsLog
public class JdbcPreparedStatement extends JdbcStatement implements PreparedStatement, JdbcWrapper {

    private final String sql;

    private Object[] agrs;

    public JdbcPreparedStatement(JdbcConnection connection, String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        super(connection, resultSetType, resultSetConcurrency, resultSetHoldability);
        this.sql = sql;
        int count = StringUtils.countMatches(sql, "?");
        agrs = new Object[count];
    }
    ...
    public ResultSet executeQuery() throws SQLException {
        try {
            QueryResp queryResp = yearningService.query(connection.getSource(), connection.getCatalog(), this.sql);
    ...
    public void clearParameters() throws SQLException {
        this.agrs = new Object[agrs.length];
    }
    ...
    public boolean execute() throws SQLException {
        ...
        if (agrs != null && agrs.length > 0) {
            for (Object agr : agrs) {
                if (agr != null) {
                    if (agr.getClass() == String.class) {
                        newSql = newSql.replaceFirst("\\?", "'" + agr + "'");
                    } else {
                        newSql = newSql.replaceFirst("\\?", Objects.toString(agr));
                    }
                } else {
                    newSql = newSql.replaceFirst("\\?", "null");
                }
            }
        }
        log.info("execute:" + newSql);
        try {
            QueryResp queryResp = yearningService.query(connection.getSource(), connection.getCatalog(), newSql);
            log.info("queryResp:" + JsonUtils.writeAsString(queryResp));
            this.resultSet = new JdbcResultSet(this, connection.builderResult(queryResp));
        } catch (Exception e) {
            throw new SQLException(e);
        }
        return true;
