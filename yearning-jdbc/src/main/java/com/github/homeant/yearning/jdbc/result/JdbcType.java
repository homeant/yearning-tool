...
public enum JdbcType implements SQLType {
     ...
     */
    DECIMAL("DECIMAL", Types.DECIMAL, BigDecimal.class, JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 65L, "[(M[,D])] [UNSIGNED] [ZEROFILL]"),
    /**
     * DECIMAL[(M[,D])] UNSIGNED [ZEROFILL]
     *
     * @see JdbcType#DECIMAL
     */
    DECIMAL_UNSIGNED("DECIMAL UNSIGNED", Types.DECIMAL, BigDecimal.class, JdbcType.FIELD_FLAG_UNSIGNED | JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL,
     ...
     */
    TINYINT("TINYINT", Types.TINYINT, Integer.class, JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 3L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * TINYINT[(M)] UNSIGNED [ZEROFILL]
     *
     * @see JdbcType#TINYINT
     */
    TINYINT_UNSIGNED("TINYINT UNSIGNED", Types.TINYINT, Integer.class, JdbcType.FIELD_FLAG_UNSIGNED | JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 3L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * BOOL, BOOLEAN
     ...
     * Protocol: FIELD_TYPE_TINY = 1
     */
    BOOLEAN("BOOLEAN", Types.BOOLEAN, Boolean.class, 0, JdbcType.IS_NOT_DECIMAL, 3L, ""),
    /**
     ...
     */
    SMALLINT("SMALLINT", Types.SMALLINT, Integer.class, JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 5L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * SMALLINT[(M)] UNSIGNED [ZEROFILL]
     *
     * @see JdbcType#SMALLINT
     */
    SMALLINT_UNSIGNED("SMALLINT UNSIGNED", Types.SMALLINT, Integer.class, JdbcType.FIELD_FLAG_UNSIGNED | JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL,
     ...
     */
    INT("INT", Types.INTEGER, Integer.class, JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 10L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * INT[(M)] UNSIGNED [ZEROFILL]
     *
     * @see JdbcType#INT
     */
    INT_UNSIGNED("INT UNSIGNED", Types.INTEGER, Long.class, JdbcType.FIELD_FLAG_UNSIGNED | JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 10L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     ...
     */
    FLOAT("FLOAT", Types.REAL, Float.class, JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 12L, "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * FLOAT[(M,D)] UNSIGNED [ZEROFILL]
     *
     * @see JdbcType#FLOAT
     */
    FLOAT_UNSIGNED("FLOAT UNSIGNED", Types.REAL, Float.class, JdbcType.FIELD_FLAG_UNSIGNED | JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 12L,
     ...
     */
    DOUBLE("DOUBLE", Types.DOUBLE, Double.class, JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 22L, "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * DOUBLE[(M,D)] UNSIGNED [ZEROFILL]
     *
     * @see JdbcType#DOUBLE
     */
    DOUBLE_UNSIGNED("DOUBLE UNSIGNED", Types.DOUBLE, Double.class, JdbcType.FIELD_FLAG_UNSIGNED | JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 22L,
            "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * FIELD_TYPE_NULL = 6
     */
    NULL("NULL", Types.NULL, Object.class, 0, JdbcType.IS_NOT_DECIMAL, 0L, ""),
    /**
     * TIMESTAMP[(fsp)]
    ...
    TIMESTAMP("TIMESTAMP", Types.TIMESTAMP, Timestamp.class, 0, JdbcType.IS_NOT_DECIMAL, 26L, "[(fsp)]"),
    /**
     ...
     */
    BIGINT("BIGINT", Types.BIGINT, Long.class, JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 19L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * BIGINT[(M)] UNSIGNED [ZEROFILL]
     *
     * @see JdbcType#BIGINT
     */
    BIGINT_UNSIGNED("BIGINT UNSIGNED", Types.BIGINT, BigInteger.class, JdbcType.FIELD_FLAG_UNSIGNED | JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 20L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     ...
     */
    MEDIUMINT("MEDIUMINT", Types.INTEGER, Integer.class, JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL, 7L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * MEDIUMINT[(M)] UNSIGNED [ZEROFILL]
     *
     * @see JdbcType#MEDIUMINT
     */
    MEDIUMINT_UNSIGNED("MEDIUMINT UNSIGNED", Types.INTEGER, Integer.class, JdbcType.FIELD_FLAG_UNSIGNED | JdbcType.FIELD_FLAG_ZEROFILL, JdbcType.IS_DECIMAL,
     ...
     */
    DATE("DATE", Types.DATE, Date.class, 0, JdbcType.IS_NOT_DECIMAL, 10L, ""),
    /**
     * TIME[(fsp)]
     ...
     */
    TIME("TIME", Types.TIME, Time.class, 0, JdbcType.IS_NOT_DECIMAL, 16L, "[(fsp)]"),
    /**
     * DATETIME[(fsp)]
     ...
     */
    DATETIME("DATETIME", Types.TIMESTAMP, Timestamp.class, 0, JdbcType.IS_NOT_DECIMAL, 26L, "[(fsp)]"),
    /**
     * YEAR[(4)]
     ...
     */
    YEAR("YEAR", Types.DATE, Date.class, 0, JdbcType.IS_NOT_DECIMAL, 4L, "[(4)]"),
    /**
     ...
     */
    VARCHAR("VARCHAR", Types.VARCHAR, String.class, 0, JdbcType.IS_NOT_DECIMAL, 65535L, "(M) [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * VARBINARY(M)
     ...
     * Protocol: FIELD_TYPE_VAR_STRING = 253
     */
    VARBINARY("VARBINARY", Types.VARBINARY, null, 0, JdbcType.IS_NOT_DECIMAL, 65535L, "(M)"),
    /**
     * BIT[(M)]
     * A bit-field type. M indicates the number of bits per value, from 1 to 64. The default is 1 if M is omitted.
     * Protocol: FIELD_TYPE_BIT = 16
     */
    BIT("BIT", Types.BIT, Boolean.class, 0, JdbcType.IS_DECIMAL, 1L, "[(M)]"), // TODO maybe precision=8 ?
    /**
     ...
     */
    JSON("JSON", Types.LONGVARCHAR, String.class, 0, JdbcType.IS_NOT_DECIMAL, 1073741824L, ""),
    /**
     ...
     */
    ENUM("ENUM", Types.CHAR, String.class, 0, JdbcType.IS_NOT_DECIMAL, 65535L,
     ...
     */
    SET("SET", Types.CHAR, String.class, 0, JdbcType.IS_NOT_DECIMAL, 64L, "('value1','value2',...) [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * TINYBLOB
     ...
     */
    TINYBLOB("TINYBLOB", Types.VARBINARY, null, 0, JdbcType.IS_NOT_DECIMAL, 255L, ""),
    /**
     ...
     * Protocol:FIELD_TYPE_TINY_BLOB = 249
     */
    TINYTEXT("TINYTEXT", Types.VARCHAR, String.class, 0, JdbcType.IS_NOT_DECIMAL, 255L, " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * MEDIUMBLOB
     ...
     */
    MEDIUMBLOB("MEDIUMBLOB", Types.LONGVARBINARY, null, 0, JdbcType.IS_NOT_DECIMAL, 16777215L, ""),
    /**
     ...
     * Protocol: FIELD_TYPE_MEDIUM_BLOB = 250
     */
    MEDIUMTEXT("MEDIUMTEXT", Types.LONGVARCHAR, String.class, 0, JdbcType.IS_NOT_DECIMAL, 16777215L, " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * LONGBLOB
     ...
     */
    LONGBLOB("LONGBLOB", Types.LONGVARBINARY, null, 0, JdbcType.IS_NOT_DECIMAL, 4294967295L, ""),
    /**
     ...
     * Protocol: FIELD_TYPE_LONG_BLOB = 251
     */
    LONGTEXT("LONGTEXT", Types.LONGVARCHAR, String.class, 0, JdbcType.IS_NOT_DECIMAL, 4294967295L, " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * BLOB[(M)]
     ...
     */
    BLOB("BLOB", Types.LONGVARBINARY, null, 0, JdbcType.IS_NOT_DECIMAL, 65535L, "[(M)]"),
    /**
     ...
     * Protocol: FIELD_TYPE_BLOB = 252
     */
    TEXT("TEXT", Types.LONGVARCHAR, String.class, 0, JdbcType.IS_NOT_DECIMAL, 65535L, "[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     ...
     */
    CHAR("CHAR", Types.CHAR, String.class, 0, JdbcType.IS_NOT_DECIMAL, 255L, "[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * BINARY(M)
     ...
     */
    BINARY("BINARY", Types.BINARY, null, 0, JdbcType.IS_NOT_DECIMAL, 255L, "(M)"),
    /**
     * Top class for Spatial Data Types
     *
     * Protocol: FIELD_TYPE_GEOMETRY = 255
     */
    GEOMETRY("GEOMETRY", Types.BINARY, null, 0, JdbcType.IS_NOT_DECIMAL, 65535L, ""), // TODO check precision, it isn't well documented, only mentioned that WKB format is represented by BLOB 
    /**
     ...
     * Has no protocol ID.
     */
    UNKNOWN("UNKNOWN", Types.OTHER, null, 0, JdbcType.IS_NOT_DECIMAL, 65535L, "");
    ...
    JdbcType(String name, int jdbcType, Class<?> javaClass, int allowedFlags, boolean isDecimal,Long precision,String createParams){
        this.name = name;
    ...
    public static JdbcType getByName(String fullJdbcTypeName) {


        String typeName = "";

        if (fullJdbcTypeName.indexOf("(") != -1) {
            typeName = fullJdbcTypeName.substring(0, fullJdbcTypeName.indexOf("(")).trim();
        } else {
            typeName = fullJdbcTypeName;
        }
        ...
        if (StringUtils.indexOfIgnoreCase(typeName, "DECIMAL") != -1 || StringUtils.indexOfIgnoreCase(typeName, "DEC") != -1
            ...
            return StringUtils.indexOfIgnoreCase(fullJdbcTypeName, "UNSIGNED") != -1 ? DECIMAL_UNSIGNED : DECIMAL;
            ...
            return StringUtils.indexOfIgnoreCase(fullJdbcTypeName, "UNSIGNED") != -1 || StringUtils.indexOfIgnoreCase(fullJdbcTypeName, "ZEROFILL") != -1
                    ? TINYINT_UNSIGNED
                    : TINYINT;
    ...
    public static JdbcType getByJdbcType(int jdbcType) {
        switch (jdbcType) {
            case Types.BIGINT:
                return BIGINT;
            case Types.BINARY:
    ...
    public static boolean isSigned(JdbcType type) {
        switch (type) {
            case DECIMAL:
            case TINYINT:
            case SMALLINT:
